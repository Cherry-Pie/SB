      ...
      <div class="panel panel-default">
          ...
          <div class="panel-body">
              ...
              <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                ...
                <input name="item_name" type="hidden" value="standart for user ID:<?=Yii::$app->user->identity->id?>"/>
                <input name="item_number" type="hidden" value="standart;<?=Yii::$app->user->identity->id?>" />
                <input name="amount" type="hidden" value="59" />
                <input name="no_shipping" type="hidden" value="1" />
                <input name="rm" type="hidden" value="0" />
                <input name="return" type="hidden" value="http://site.ru/order/success/" />
