			...
			<div class="monthly-plans">				
				...
				<table class="table table-striped table-hover monthly-plans-table">
					...
					<tfoot>
						<tr>
							<td></td>
							<!-- <td><a href="/<?php the_field('first_plan_button_link_url', 'option'); ?>"><?php the_field('first_plan_button_link_text', 'option'); ?></a></td> -->
							...
							<td><a href="http://cp.scanbacklinks.com/user/profile"><?php the_field('second_plan_button_link_text', 'option'); ?></a></td>
							<td><a href="http://cp.scanbacklinks.com/user/profile"><?php the_field('third_plan_button_link_text', 'option'); ?></a></td>
						</tr>
					</tfoot>
				</table>
			</div>
